# The name of this view in Looker is "Adventure Works Sales 2016"
view: adventure_works_sales_2016 {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `ai-accelerators-dai.BTG_Looker_Demo.AdventureWorks_Sales_2016`
    ;;
